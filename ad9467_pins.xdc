...
create_clock -period 8 -name cca_clk [get_ports { clk_125_p }];
...
set_property -dict {  PACKAGE_PIN H19  DIFF_TERM TRUE   IOSTANDARD LVDS} [ get_ports { adc_data_in_p[6] }];
set_property -dict {  PACKAGE_PIN G19  DIFF_TERM TRUE   IOSTANDARD LVDS} [ get_ports { adc_data_in_n[6] }];
